    ...
    <body>
        <div class="travel-shell">
            <main class="travel-page">
                <header class="topbar">
                    <a class="brand" href="/">Nomad Nest</a>

                    <nav class="topnav">
                        <a href="#destinations">Маршруты</a>
                        <a href="#benefits">Преимущества</a>
                        <a href="#packages">Туры</a>
                        <a href="#booking">Бронирование</a>
                    </nav>

                    <a class="topbar__cta" href="#booking">Подобрать тур</a>
                </header>
                ...
                <section class="hero">
                    <div class="hero__content">
                        ...
                        <div class="hero__actions">
                            <a class="button button--light" href="#destinations">Смотреть туры</a>
                            <a class="button button--ghost" href="#booking">Забронировать</a>
                        </div>
                    </div>
                ...
                <section class="destinations" id="destinations">
                    ...
                    <div class="destination-grid">
                        <article class="destination-card destination-card--tall">
                            <img src="https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=900&q=80" alt="Горы">
                        ...
                        <article class="destination-card">
                            <img src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=900&q=80" alt="Пляж">
                            <div class="destination-card__overlay">
                                <span>от 62 000 ₽</span>
                                <h3>Бали</h3>
                        ...
                        <article class="destination-card">
                            <img src="https://images.unsplash.com/photo-1501785888041-af3ef285b470?auto=format&fit=crop&w=900&q=80" alt="Долина">
                            <div class="destination-card__overlay">
                                <span>от 39 000 ₽</span>
                                <h3>Грузия</h3>
                        ...
                        <article class="destination-card destination-card--wide">
                            <img src="https://images.unsplash.com/photo-1517760444937-f6397edcbbcd?auto=format&fit=crop&w=1200&q=80" alt="Город у воды">
                            <div class="destination-card__overlay">
                                <span>от 55 000 ₽</span>
                                <h3>Стамбул</h3>
